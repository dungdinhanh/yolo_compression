...
#        'lr0': 0.02,  # initial learning rate (SGD=5E-3, Adam=5E-4)
...
# =======
# >>>>>>> b5f8163b0f60e8dae166ad136c1966f6d2c1949d
...
if __name__ == '__main__':
    ...
    while os.path.isdir(results_folder):
        ...
        count += 1
        results_folder = os.path.join(RESULTS, opt.name + "_%d"%(count))
    ...
    hyper = {
        #'giou': 3.54,  # giou loss gain
           ...
           'obj_pw': 1.0,  # obj BCELoss positive_weight
           'iou_t': 0.20,  # iou training threshold
           'lr0': 0.03,  # initial learning rate (SGD=5E-3, Adam=5E-4)
           'lrf': 0.0005,  # final learning rate (with cos scheduler)
           'momentum': 0.937,  # SGD momentum
           'weight_decay': 0.0005,  # optimizer weight decay
           'fl_gamma': 0.0,  # focal loss gamma (efficientDet default is gamma=1.5)
