...
from utils_cfg.utils import xyxy2xywh, xywh2xyxy
...
def reduce_img_size(path='../data/sm4/images', img_size=1024):  # from utils_cfg.datasets import *; reduce_img_size()
...
def convert_images2bmp():  # from utils_cfg.datasets import *; convert_images2bmp()
    # Save images
...
def recursive_dataset2bmp(dataset='../data/sm4_bmp'):  # from utils_cfg.datasets import *; recursive_dataset2bmp()
...
def imagelist2folder(path='data/coco_64img.txt'):  # from utils_cfg.datasets import *; imagelist2folder()
